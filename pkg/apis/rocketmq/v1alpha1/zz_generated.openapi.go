	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"size", "replicaPerGroup", "brokerImage", "imagePullPolicy", "allowRestart", "resources", "storageMode", "hostPath", "volumeClaimTemplates", "scalePodName"},
			},
		},
		Dependencies: []string{
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"size", "nameServiceImage", "imagePullPolicy", "hostNetwork", "dnsPolicy", "resources", "storageMode", "hostPath", "volumeClaimTemplates"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.PersistentVolumeClaim", "k8s.io/api/core/v1.ResourceRequirements"},
